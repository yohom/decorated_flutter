...
class ThrottleInterceptor extends Interceptor {
  final Map<String, Timer> _requestTimers = {}; // 记录请求的节流状态
  final Duration duration; // 防抖间隔
  ...
  void onRequest(RequestOptions options, RequestInterceptorHandler handler) {
    ...
    _requestTimers[key] = Timer(duration, () {
  ...
  String _generateRequestKey(RequestOptions options) {
    return '${options.method}-${options.uri.toString()}-${options.data.toString()}';
  }
}
